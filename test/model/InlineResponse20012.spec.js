...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20012();
  });
  ...
  describe('InlineResponse20012', function() {
    it('should create an instance of InlineResponse20012', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20012();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20012);
    });

    it('should have the property ready (base name: "ready")', function() {
      // uncomment below and update the code to test the property ready
      //var instance = new ProcessMakerApi.InlineResponse20012();
