...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject3();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject3);
    });
    ...
    it('should have the property messageIds (base name: "message_ids")', function() {
      ...
      //var instance = new ProcessMakerApi.InlineObject3();
