...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instane = new ProcessMakerApi.Metadata();
      //expect(instance).to.be.a(ProcessMakerApi.Metadata);
    });

    it('should have the property filter (base name: "filter")', function() {
      // uncomment below and update the code to test the property filter
      //var instance = new ProcessMakerApi.Metadata();
