...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject2();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject2);
    });
    ...
    it('should have the property messageIds (base name: "message_ids")', function() {
      ...
      //var instance = new ProcessMakerApi.InlineObject2();
