...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ProcessRequestAllOf();
  });
  ...
  describe('ProcessRequestAllOf', function() {
    it('should create an instance of ProcessRequestAllOf', function() {
      // uncomment below and update the code to test ProcessRequestAllOf
      //var instane = new ProcessMakerApi.ProcessRequestAllOf();
      //expect(instance).to.be.a(ProcessMakerApi.ProcessRequestAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.ProcessRequestAllOf();
