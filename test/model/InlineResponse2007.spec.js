...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse2007();
  });
  ...
  describe('InlineResponse2007', function() {
    it('should create an instance of InlineResponse2007', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse2007();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse2007);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineResponse2007();
