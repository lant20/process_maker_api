...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskMetadataAllOf();
  });
  ...
  describe('TaskMetadataAllOf', function() {
    it('should create an instance of TaskMetadataAllOf', function() {
      // uncomment below and update the code to test TaskMetadataAllOf
      //var instane = new ProcessMakerApi.TaskMetadataAllOf();
      //expect(instance).to.be.a(ProcessMakerApi.TaskMetadataAllOf);
    });

    it('should have the property filter (base name: "filter")', function() {
      // uncomment below and update the code to test the property filter
      //var instance = new ProcessMakerApi.TaskMetadataAllOf();
