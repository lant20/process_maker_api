...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupsAllOf();
  });
  ...
  describe('GroupsAllOf', function() {
    it('should create an instance of GroupsAllOf', function() {
      ...
      //var instane = new ProcessMakerApi.GroupsAllOf();
      //expect(instance).to.be.a(ProcessMakerApi.GroupsAllOf);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new ProcessMakerApi.GroupsAllOf();
