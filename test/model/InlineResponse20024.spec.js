...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20024();
  });
  ...
  describe('InlineResponse20024', function() {
    it('should create an instance of InlineResponse20024', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20024();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20024);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineResponse20024();
