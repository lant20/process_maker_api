...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse422();
  });
  ...
  describe('InlineResponse422', function() {
    it('should create an instance of InlineResponse422', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse422();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse422);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new ProcessMakerApi.InlineResponse422();
