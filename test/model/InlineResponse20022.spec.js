...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20022();
  });
  ...
  describe('InlineResponse20022', function() {
    it('should create an instance of InlineResponse20022', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20022();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20022);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new ProcessMakerApi.InlineResponse20022();
