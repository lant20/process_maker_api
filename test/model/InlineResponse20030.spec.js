...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20030();
  });
  ...
  describe('InlineResponse20030', function() {
    it('should create an instance of InlineResponse20030', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20030();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20030);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineResponse20030();
