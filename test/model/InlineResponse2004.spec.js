...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse2004();
  });
  ...
  describe('InlineResponse2004', function() {
    it('should create an instance of InlineResponse2004', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse2004();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse2004);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineResponse2004();
