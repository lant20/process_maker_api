...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.UserToken();
  });
  ...
  describe('UserToken', function() {
    it('should create an instance of UserToken', function() {
      ...
      //var instane = new ProcessMakerApi.UserToken();
      //expect(instance).to.be.a(ProcessMakerApi.UserToken);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.UserToken();
