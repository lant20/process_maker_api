...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject13();
  });
  ...
  describe('InlineObject13', function() {
    it('should create an instance of InlineObject13', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject13();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject13);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new ProcessMakerApi.InlineObject13();
