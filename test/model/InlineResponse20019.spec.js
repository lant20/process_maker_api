...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20019();
  });
  ...
  describe('InlineResponse20019', function() {
    it('should create an instance of InlineResponse20019', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20019();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20019);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineResponse20019();
