...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20017();
  });
  ...
  describe('InlineResponse20017', function() {
    it('should create an instance of InlineResponse20017', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20017();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20017);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineResponse20017();
