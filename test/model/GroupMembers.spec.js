...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupMembers();
  });
  ...
  describe('GroupMembers', function() {
    it('should create an instance of GroupMembers', function() {
      ...
      //var instane = new ProcessMakerApi.GroupMembers();
      //expect(instance).to.be.a(ProcessMakerApi.GroupMembers);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.GroupMembers();
