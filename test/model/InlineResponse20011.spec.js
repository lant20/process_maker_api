...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineResponse20011();
  });
  ...
  describe('InlineResponse20011', function() {
    it('should create an instance of InlineResponse20011', function() {
      ...
      //var instane = new ProcessMakerApi.InlineResponse20011();
      //expect(instance).to.be.a(ProcessMakerApi.InlineResponse20011);
    });

    it('should have the property url (base name: "url")', function() {
      // uncomment below and update the code to test the property url
      //var instance = new ProcessMakerApi.InlineResponse20011();
