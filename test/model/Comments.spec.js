...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.Comments();
  });
  ...
  describe('Comments', function() {
    it('should create an instance of Comments', function() {
      ...
      //var instane = new ProcessMakerApi.Comments();
      //expect(instance).to.be.a(ProcessMakerApi.Comments);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new ProcessMakerApi.Comments();
