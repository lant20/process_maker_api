...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.SecurityLogMeta();
  });
  ...
  describe('SecurityLogMeta', function() {
    it('should create an instance of SecurityLogMeta', function() {
      // uncomment below and update the code to test SecurityLogMeta
      //var instane = new ProcessMakerApi.SecurityLogMeta();
      //expect(instance).to.be.a(ProcessMakerApi.SecurityLogMeta);
    });

    it('should have the property os (base name: "os")', function() {
      // uncomment below and update the code to test the property os
      //var instance = new ProcessMakerApi.SecurityLogMeta();
