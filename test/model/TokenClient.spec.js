...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TokenClient();
  });
  ...
  describe('TokenClient', function() {
    it('should create an instance of TokenClient', function() {
      // uncomment below and update the code to test TokenClient
      //var instane = new ProcessMakerApi.TokenClient();
      //expect(instance).to.be.a(ProcessMakerApi.TokenClient);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.TokenClient();
