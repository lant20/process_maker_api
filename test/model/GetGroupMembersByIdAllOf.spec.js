...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GetGroupMembersByIdAllOf();
  });
  ...
  describe('GetGroupMembersByIdAllOf', function() {
    it('should create an instance of GetGroupMembersByIdAllOf', function() {
      // uncomment below and update the code to test GetGroupMembersByIdAllOf
      //var instane = new ProcessMakerApi.GetGroupMembersByIdAllOf();
      //expect(instance).to.be.a(ProcessMakerApi.GetGroupMembersByIdAllOf);
    });

    it('should have the property groupId (base name: "group_id")', function() {
      // uncomment below and update the code to test the property groupId
      //var instance = new ProcessMakerApi.GetGroupMembersByIdAllOf();
