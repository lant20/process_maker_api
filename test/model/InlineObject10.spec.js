...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject10();
  });
  ...
  describe('InlineObject10', function() {
    it('should create an instance of InlineObject10', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject10();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject10);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ProcessMakerApi.InlineObject10();
