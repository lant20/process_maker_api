...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject);
    });
    ...
    it('should have the property variables (base name: "variables")', function() {
      ...
      //var instance = new ProcessMakerApi.InlineObject();
