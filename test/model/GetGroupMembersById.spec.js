...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GetGroupMembersById();
  });
  ...
  describe('GetGroupMembersById', function() {
    it('should create an instance of GetGroupMembersById', function() {
      // uncomment below and update the code to test GetGroupMembersById
      //var instane = new ProcessMakerApi.GetGroupMembersById();
      //expect(instance).to.be.a(ProcessMakerApi.GetGroupMembersById);
    });

    it('should have the property groupId (base name: "group_id")', function() {
      // uncomment below and update the code to test the property groupId
      //var instance = new ProcessMakerApi.GetGroupMembersById();
