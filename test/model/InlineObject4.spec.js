...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject4();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject4);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.InlineObject4();
