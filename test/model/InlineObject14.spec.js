...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InlineObject14();
  });
  ...
  describe('InlineObject14', function() {
    it('should create an instance of InlineObject14', function() {
      ...
      //var instane = new ProcessMakerApi.InlineObject14();
      //expect(instance).to.be.a(ProcessMakerApi.InlineObject14);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new ProcessMakerApi.InlineObject14();
