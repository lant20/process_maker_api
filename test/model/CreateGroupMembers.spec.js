...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.CreateGroupMembers();
  });
  ...
  describe('CreateGroupMembers', function() {
    it('should create an instance of CreateGroupMembers', function() {
      // uncomment below and update the code to test CreateGroupMembers
      //var instane = new ProcessMakerApi.CreateGroupMembers();
      //expect(instance).to.be.a(ProcessMakerApi.CreateGroupMembers);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.CreateGroupMembers();
