...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.Users();
  });
  ...
  describe('Users', function() {
    it('should create an instance of Users', function() {
      ...
      //var instane = new ProcessMakerApi.Users();
      //expect(instance).to.be.a(ProcessMakerApi.Users);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ProcessMakerApi.Users();
