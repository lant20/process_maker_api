...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.Groups();
  });
  ...
  describe('Groups', function() {
    it('should create an instance of Groups', function() {
      ...
      //var instane = new ProcessMakerApi.Groups();
      //expect(instance).to.be.a(ProcessMakerApi.Groups);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new ProcessMakerApi.Groups();
