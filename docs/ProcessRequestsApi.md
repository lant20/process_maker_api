# ProcessMakerApi.ProcessRequestsApi
...
[**updateProcessRequestEvent**](ProcessRequestsApi.md#updateProcessRequestEvent) | **POST** /requests/{process_request_id}/events/{event_id} | Update a process request event
...
let apiInstance = new ProcessMakerApi.ProcessRequestsApi();
let processRequestId = 56; // Number | ID of process request to return
apiInstance.deleteProcessRequest(processRequestId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **processRequestId** | **Number**| ID of process request to return | 
...
> ProcessRequest getProcessRequestById(processRequestId, opts)
...
apiInstance.getProcessRequestById(processRequestId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> InlineResponse20013 getProcessesRequests(opts)
...
let apiInstance = new ProcessMakerApi.ProcessRequestsApi();
let opts = {
  'type': "type_example", // String | Only return requests by type (all|in_progress|completed)
...
apiInstance.getProcessesRequests(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **type** | **String**| Only return requests by type (all|in_progress|completed) | [optional] 
...
> updateProcessRequest(processRequestId, processRequestEditable)
...
let apiInstance = new ProcessMakerApi.ProcessRequestsApi();
let processRequestId = 56; // Number | ID of process request to return
let processRequestEditable = new ProcessMakerApi.ProcessRequestEditable(); // ProcessRequestEditable | 
apiInstance.updateProcessRequest(processRequestId, processRequestEditable, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
## updateProcessRequestEvent

> updateProcessRequestEvent(processRequestId, eventId)
...
let apiInstance = new ProcessMakerApi.ProcessRequestsApi();
let processRequestId = "processRequestId_example"; // String | ID of process request to return
let eventId = "eventId_example"; // String | ID of process event to return
apiInstance.updateProcessRequestEvent(processRequestId, eventId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **eventId** | **String**| ID of process event to return | 
