# ProcessMakerApi.FilesApi

All URIs are relative to *http://localhost/api/1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createFile**](FilesApi.md#createFile) | **POST** /files | Save a new media file. Note: To upload files to a request, use createRequestFile in the RequestFile API
[**deleteFile**](FilesApi.md#deleteFile) | **DELETE** /files/{file_id} | Delete a media file
[**getFileById**](FilesApi.md#getFileById) | **GET** /files/{file_id} | Get the metadata of a file. To actually fetch the file see Get File Contents
[**getFileContentsById**](FilesApi.md#getFileContentsById) | **GET** /files/{file_id}/contents | Get the contents of a file
[**getFiles**](FilesApi.md#getFiles) | **GET** /files | Returns the list of files



## createFile

> InlineResponse2002 createFile(modelId, model, opts)
...
let apiInstance = new ProcessMakerApi.FilesApi();
let modelId = 56; // Number | ID of the model to which the file will be associated
let model = "model_example"; // String | Full namespaced class of the model to associate
let opts = {
  'dataName': "dataName_example", // String | Name of the variable used in a request
  'collection': "collection_example", // String | Media collection name. For requests, use 'default'
...
------------- | ------------- | ------------- | -------------
 **modelId** | **Number**| ID of the model to which the file will be associated | 
 **model** | **String**| Full namespaced class of the model to associate | 
 **dataName** | **String**| Name of the variable used in a request | [optional] 
 **collection** | **String**| Media collection name. For requests, use &#39;default&#39; | [optional] 
...
> File getFileContentsById(fileId)
...
let apiInstance = new ProcessMakerApi.FilesApi();
let fileId = 56; // Number | ID of the file to return
apiInstance.getFileContentsById(fileId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> InlineResponse2001 getFiles(opts)
...
apiInstance.getFiles(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
