...
var _ProcessWithStartEvents = _interopRequireDefault(require("./ProcessWithStartEvents"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_ProcessWithStartEvents["default"]]);
        }
...
/**
 * @member {Array.<module:model/ProcessWithStartEvents>} data
 */
