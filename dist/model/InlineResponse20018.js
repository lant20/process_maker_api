...
var _ScriptCategory = _interopRequireDefault(require("./ScriptCategory"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_ScriptCategory["default"]]);
        }
...
/**
 * @member {Array.<module:model/ScriptCategory>} data
 */
