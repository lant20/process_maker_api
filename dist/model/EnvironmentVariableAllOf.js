 ...
 * @version 1.0.0
 */
var EnvironmentVariableAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EnvironmentVariableAllOf</code>.
   * @alias module:model/EnvironmentVariableAllOf
   */
  function EnvironmentVariableAllOf() {
    _classCallCheck(this, EnvironmentVariableAllOf);
  ...
  _createClass(EnvironmentVariableAllOf, null, [{
    key: "initialize",
  ...
  return EnvironmentVariableAllOf;
}();
/**
 * @member {Number} id
 */
...
var _default = EnvironmentVariableAllOf;
