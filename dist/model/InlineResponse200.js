...
var _EnvironmentVariable = _interopRequireDefault(require("./EnvironmentVariable"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_EnvironmentVariable["default"]]);
        }
...
/**
 * @member {Array.<module:model/EnvironmentVariable>} data
 */
