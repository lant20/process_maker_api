  ...
  _createClass(InlineObject12, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('pidFile')) {
          obj['pidFile'] = _ApiClient["default"].convertToType(data['pidFile'], 'String');
        }
      }
...
/**
 * @member {String} pidFile
 */


InlineObject12.prototype['pidFile'] = undefined;
