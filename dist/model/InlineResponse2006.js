...
var _AvailableGroupMembers = _interopRequireDefault(require("./AvailableGroupMembers"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_AvailableGroupMembers["default"]]);
        }
...
/**
 * @member {Array.<module:model/AvailableGroupMembers>} data
 */
