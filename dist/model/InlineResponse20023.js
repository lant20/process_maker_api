...
var _AvailableLanguages = _interopRequireDefault(require("./AvailableLanguages"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_AvailableLanguages["default"]]);
        }
