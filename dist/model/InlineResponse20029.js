...
var _ProcessRequestToken = _interopRequireDefault(require("./ProcessRequestToken"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_ProcessRequestToken["default"]]);
        }
